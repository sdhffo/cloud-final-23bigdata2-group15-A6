...
![76752984457](C:\Users\dell\AppData\Local\Temp\1767529844570.png)
...
- 步骤 1：编写应用代码与依赖文件
  ...
  - 输出/结果：
    ...
    ![76753767522](C:\Users\dell\AppData\Local\Temp\1767537675220.png)

    ![76753778012](C:\Users\dell\AppData\Local\Temp\1767537780127.png)
...
- 步骤 2：编写基础 Dockerfile 并构建镜像
  ...
  - 输出/结果：
    ...
    ![76753845172](C:\Users\dell\AppData\Local\Temp\1767538451728.png)

    ![76753809232](C:\Users\dell\AppData\Local\Temp\1767538092327.png)

    ![76753817542](C:\Users\dell\AppData\Local\Temp\1767538175428.png)
...
- 步骤 3：演示容器运行参数配置
  ...
  - 输出/结果：
    ...
    ![76754037159](C:\Users\dell\AppData\Local\Temp\1767540371599.png)

    ![76754040929](C:\Users\dell\AppData\Local\Temp\1767540409298.png)

    2. 端口映射演示

    ![76754087275](C:\Users\dell\AppData\Local\Temp\1767540872753.png)

    3. 主机目录挂载演示

    - 启动容器并确认容器正常运行

    ![76754175430](C:\Users\dell\AppData\Local\Temp\1767541754309.png)

    - 访问初始页面

    ![76754168042](C:\Users\dell\AppData\Local\Temp\1767541680420.png)

    - 修改本地代码并验证同步（无需重启容器，直接刷新浏览器 http://localhost:8080）

    ![76754191318](C:\Users\dell\AppData\Local\Temp\1767541913185.png)

    ![76754298576](C:\Users\dell\AppData\Local\Temp\1767542985762.png)

    - 进入容器验证文件同步

    ![76754314179](C:\Users\dell\AppData\Local\Temp\1767543141799.png)

    ![76754317190](C:\Users\dell\AppData\Local\Temp\1767543171909.png)

    4. 命名卷挂载演示

    - 启动容器并挂载卷

    ![76754354674](C:\Users\dell\AppData\Local\Temp\1767543546742.png)

    - 准备测试文件（模拟日志）

    ![76754360647](C:\Users\dell\AppData\Local\Temp\1767543606474.png)

    - 删除容器（模拟容器故障 / 重启）

    ![76754366166](C:\Users\dell\AppData\Local\Temp\1767543661665.png)

    - 重新启动容器并挂载同名卷，验证数据持久化

    ![76754370475](C:\Users\dell\AppData\Local\Temp\1767543704759.png)

    - 查看卷的物理存储位置

    ![76754374305](C:\Users\dell\AppData\Local\Temp\1767543743056.png)
...
- 步骤 4：镜像版本管理与标签操作
  ...
  - 输出/结果：
    ...
    ![76754541519](C:\Users\dell\AppData\Local\Temp\1767545415199.png)

    ![76754544888](C:\Users\dell\AppData\Local\Temp\1767545448882.png)
...
- 步骤 5：多阶段构建实现镜像瘦身
  ...
  - 输出/结果：
    ...
    ![76754605856](C:\Users\dell\AppData\Local\Temp\1767546058565.png)

    ![76754609503](C:\Users\dell\AppData\Local\Temp\1767546095038.png)
...
- 步骤 6：验证瘦身镜像功能
  ...
  - 输出/结果：
    ...
    ![76754623738](C:\Users\dell\AppData\Local\Temp\1767546237384.png)
...
- **关键截图/输出**：
  ...
  1. 镜像构建成功截图
     ...
     ![76754779873](C:\Users\dell\AppData\Local\Temp\1767547798732.png)

  2. 应用访问成功截图（显示环境变量效果）

     ![76754786265](C:\Users\dell\AppData\Local\Temp\1767547862653.png)

  3. 镜像体积对比截图（`docker images docker-demo`输出）

     ![76754753804](C:\Users\dell\AppData\Local\Temp\1767547538042.png)

  4. 本地 Registry 镜像推送成功截图

     ![76754760104](C:\Users\dell\AppData\Local\Temp\1767547601045.png)
